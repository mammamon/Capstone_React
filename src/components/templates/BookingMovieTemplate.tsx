...
export const BookingMovieTemplate = () => {
  ...
  const { chairList, isFetchingChairList, isFetchingBookedList} = useSelector(
      ...
      <div className="flex mt-10 justify-between">
                ...
                <Col key={ghe.maGhe} span={2}>
                  <Button
                    ...
                    className={cs(
                      ...
                      "!px-0",
                      "!w-full",
                      { selected: select?.some((x) => x.maGhe == ghe.maGhe) }
                    )}
                  >
                    {ghe.tenGhe}
                  </Button>
        ...
        <div className="bill w-4/12 ml-10 border p-5 h-fit shadow-xl bg-gray-200">
          ...
          <Button
            ...
            onClick={() => {
              dispatch(bookedChairListThunk(bookedchair));
              if(isFetchingBookedList){
